...
#define AUDIO_IO_RESTART_REQUIRED         0x40 /* Restart of USB node is required , after frequency changes for example */
#define AUDIO_IO_THRESHOLD_REACHED        0x08 /* this flag is set when main circular buffer fill threshold is reached. Then consumer node starts reading from the buffer, this is to avoid overrun and underrun in the begin of streaming*/
